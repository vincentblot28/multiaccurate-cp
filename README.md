...
## Residual data
```
$ python multiaccurate_cp/main.py infer --model-dir=data/03_model_weights --model-name=20240318_1244 --data-dir=data/02_prepared_data --ml-set=res --output-dir=data/04_predictions/ --mean-RGB-values-path=data/01_raw_images/rgb_means.npy
```
